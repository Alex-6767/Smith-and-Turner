...
(function () {
  ...
  if(form){
    ...
    form.addEventListener("submit",function(ev){
      ...
      function reveal(openMail){ form.style.display="none"; if(ok){ok.classList.add("show");var l=ok.querySelector("[data-mailto]");if(l)l.setAttribute("href",mail);ok.scrollIntoView({behavior:reduce?"auto":"smooth",block:"center"});} if(openMail) window.location.href=mail; }
